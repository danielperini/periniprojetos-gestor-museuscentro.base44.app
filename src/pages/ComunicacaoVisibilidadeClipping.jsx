...
const CLIPPING_ITEMS = [
  {
    ...
    relevance: 'Alta',
    platform: 'Site',
    relatedTo: ['Museus Centro', 'MIS BH', 'MHAB', 'MUMO', 'Viaduto das Artes', '#MuseusCentro'],
    url: 'https://prefeitura.pbh.gov.br/noticias/24a-semana-nacional-de-museus-agita-programacao-de-maio-em-bh',
    summary: 'Publicação da PBH sobre programação de maio com menção direta ao projeto e aos museus participantes.',
  },
  {
    id: '2026-05-bheventos',
  ...
  },
  {
    ...
    summary: 'Página institucional com descrição do projeto, museus participantes e parceria com o Viaduto das Artes.',
  },
  {
    id: '2026-04-portal-bh',
  ...
  },
  {
    ...
    summary: 'Agenda cultural com foco em oficinas e experiências do projeto.',
  },
  {
    id: '2026-04-reddit-bh',
    ...
    relevance: 'Média',
    platform: 'Reddit',
    relatedTo: ['Museu da Moda', 'MIS BH', 'Museus de BH', '#MuseusBH'],
  ...
  },
  {
    ...
    summary: 'Publicação de agenda com atividades do mês das mulheres e menção ao Museus Centro.',
  },
  {
    id: '2026-02-agenciamg-mis',
    ...
    summary: 'Divulgação da exposição Do Traço ao Pixel, inaugurada no MIS BH em fevereiro.',
  },
  {
    id: '2025-12-arquivo-portal-bh',
    title: 'Arquivo de notícias Museus Centro - dezembro de 2025',
    sourceName: 'Portal Belo Horizonte',
    sourceType: 'Arquivo mensal',
    publishedDate: '2025-12-15',
    relevance: 'Média',
    platform: 'Site',
    relatedTo: ['Museus Centro', 'Arquivo histórico'],
    url: 'https://portalbelohorizonte.com.br/museuscentro/2025/noticias',
    summary: 'Arquivo histórico para consulta de publicações pretéritas.',
  },
  {
    id: '2025-06-noturno-funed',
    title: 'Noturno nos Museus: Serviço de Informação Científica Histórica e Cultural participa pela primeira vez do evento',
    sourceName: 'Funed',
    sourceType: 'Institucional parceiro',
    publishedDate: '2025-06-27',
    relevance: 'Média',
    platform: 'Site',
    relatedTo: ['Noturno nos Museus', 'Museus de BH', 'Fundação Municipal de Cultura'],
    url: 'https://www.funed.mg.gov.br/2025/06/destaque/noturno-nos-museus/',
    summary: 'Registro institucional da 10ª edição do Noturno nos Museus em Belo Horizonte.',
  },
  {
    id: '2024-12-pbh-lancamento-museus-centro',
    title: 'Exposição e catálogo marcam lançamento oficial do projeto Museus Centro',
    sourceName: 'PBH Notícias',
    sourceType: 'Imprensa institucional',
    ...
    platform: 'Site',
    relatedTo: ['Museus Centro', 'Viaduto das Artes', 'MHAB', 'MIS BH', 'MUMO'],
    url: 'https://prefeitura.pbh.gov.br/noticias/exposicao-e-catalogo-marcam-lancamento-oficial-do-projeto-museus-centro',
    summary: 'Lançamento oficial do projeto Museus Centro, em parceria com o Viaduto das Artes, conectando MHAB, MIS BH e MUMO.',
  },
  {
    id: '2024-12-pbh-noturno-127anos',
    title: 'Noturno nos Museus celebra os 127 anos de Belo Horizonte com cultura e arte',
    sourceName: 'PBH Notícias',
    sourceType: 'Imprensa institucional',
    publishedDate: '2024-12-04',
    relevance: 'Alta',
    platform: 'Site',
    relatedTo: ['Noturno nos Museus', 'Viaduto das Artes', 'Fundação Municipal de Cultura'],
    url: 'https://prefeitura.pbh.gov.br/noticias/noturno-nos-museus-celebra-os-127-anos-de-belo-horizonte-com-cultura-e-arte',
    summary: 'Divulgação da 9ª edição do Noturno nos Museus 2024, com parceria da OSC Viaduto das Artes.',
  },
  {
    id: '2024-12-portal-noturno-home',
    title: 'Noturno Nos Museus - Home - 2024',
    sourceName: 'Portal Belo Horizonte',
    sourceType: 'Canal institucional',
    publishedDate: '2024-12-06',
    relevance: 'Alta',
    platform: 'Site',
    relatedTo: ['Noturno nos Museus', 'MIS BH', 'Museus de BH'],
    url: 'https://portalbelohorizonte.com.br/noturnonosmuseus/2024',
    summary: 'Página oficial da edição 2024 do Noturno nos Museus, com programação e informações gerais.',
  },
  {
    id: '2024-12-portal-noturno-programacao',
    title: 'Noturno nos Museus 2024 - Programação',
    sourceName: 'Portal Belo Horizonte',
    sourceType: 'Canal institucional',
    publishedDate: '2024-12-06',
    relevance: 'Alta',
    platform: 'Site',
    relatedTo: ['Noturno nos Museus', 'Programação', 'Museus de BH'],
    url: 'https://portalbelohorizonte.com.br/noturnonosmuseus/2024/programacao',
    summary: 'Programação oficial da edição 2024 do Noturno nos Museus.',
  },
  {
    id: '2024-12-pbh-pampulha-noturno',
    title: 'Museus da Pampulha tem o Noturno nos Museus como destaque nas ações de dezembro',
    sourceName: 'PBH Notícias',
    sourceType: 'Imprensa institucional',
    publishedDate: '2024-12-05',
    relevance: 'Média/Alta',
    platform: 'Site',
    relatedTo: ['Noturno nos Museus', 'Viaduto das Artes', 'Museus de BH'],
    url: 'https://prefeitura.pbh.gov.br/noticias/museus-da-pampulha-tem-o-noturno-nos-museus-como-destaque-nas-acoes-de-dezembro',
    summary: 'Matéria da PBH sobre a programação de dezembro e o Noturno nos Museus 2024.',
  },
  {
    id: '2024-08-pbh-termo-museus-centro',
    title: 'FMC - Termo de Colaboração - 2024 - 0012 - Museus Centro',
    sourceName: 'PBH Portal das Parcerias',
    sourceType: 'Transparência pública',
    publishedDate: '2024-08-05',
    relevance: 'Alta',
    platform: 'Site',
    relatedTo: ['Museus Centro', 'Viaduto das Artes', 'Fundação Municipal de Cultura'],
    url: 'https://prefeitura.pbh.gov.br/portaldasparcerias/parceria/97378/ij/01202431030012',
...
function MonthPager({ page, totalPages, onPrev, onNext }) {
  if (totalPages <= 1) return null;
  return (
    <div className="flex items-center justify-end gap-2 pt-2">
      <Button type="button" size="sm" variant="outline" className="h-8 gap-1 text-xs" onClick={onPrev} disabled={page <= 0}>
        <ChevronLeft className="h-3.5 w-3.5" />
        Anterior
      </Button>
      <span className="text-xs text-gray-500">Página {page + 1} de {totalPages}</span>
      <Button type="button" size="sm" variant="outline" className="h-8 gap-1 text-xs" onClick={onNext} disabled={page >= totalPages - 1}>
        Próxima
...
export default function ComunicacaoVisibilidadeClipping() {
  ...
  function getPage(monthKey) {
    return monthPages[monthKey] || 0;
  }

  function setPage(monthKey, page) {
    setMonthPages((prev) => ({ ...prev, [monthKey]: Math.max(0, page) }));
  }
        ...
        <CardContent className="space-y-4 p-4">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">Resultados a partir de 01/01/2024, organizados por mês, com até 6 links por página.</p>
            </div>
            <div className="flex flex-wrap gap-2">
              <div className="relative w-full sm:w-80">
                <Search className="absolute left-2.5 top-2.5 h-3.5 w-3.5 text-gray-400" />
                <Input className="h-9 pl-8 text-sm" placeholder="Buscar publicação, veículo, hashtag, cauda longa..." value={query} onChange={(event) => { setQuery(event.target.value); setMonthPages({}); }} />
              </div>
              <select value={sourceFilter} onChange={(event) => { setSourceFilter(event.target.value); setMonthPages({}); }} className="h-9 rounded-md border border-gray-200 bg-white px-3 text-sm text-gray-700">
          ...
          {clippingByMonth.length === 0 ? (
            ...
            <div className="space-y-5">
              {clippingByMonth.map((group) => {
                ...
                const visibleItems = group.items.slice(safePage * PAGE_SIZE, safePage * PAGE_SIZE + PAGE_SIZE);
                ...
                return (
                  <section key={group.key} className="space-y-2">
                    ...
                    <MonthPager page={safePage} totalPages={totalPages} onPrev={() => setPage(group.key, safePage - 1)} onNext={() => setPage(group.key, safePage + 1)} />
                  </section>
                );
              })}
            </div>
